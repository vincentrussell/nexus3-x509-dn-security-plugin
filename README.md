...
wget -O /opt/sonatype/nexus/system/com/github/vincentrussell/nexus3-x509-dn-security-plugin.zip https://github.com/vincentrussell/nexus3-x509-dn-security-plugin/releases/download/0.1/nexus3-x509-dn-security-plugin.zip &&\
...
echo "reference\:file\:com/github/vincentrussell/nexus3-x509-dn-security-plugin/0.1/nexus3-x509-dn-security-plugin-0.1.jar = 200" >> /opt/sonatype/nexus/etc/karaf/startup.properties
```
